...
import asilbek.bsb.databinding.ActivityPinCodBinding
import com.google.gson.Gson

class PinCod : AppCompatActivity(), View.OnClickListener {
    private lateinit var binding: ActivityPinCodBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPinCodBinding.inflate(layoutInflater)
